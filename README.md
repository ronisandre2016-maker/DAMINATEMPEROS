[index_fixed (1).html](https://github.com/user-attachments/files/24941394/index_fixed.1.html)
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <script>
        ...
        function finalizarPedido() {
            ...
            mensagem += '(Subtotal: R$ ' + subtotal.toFixed(2) + ' + Entrega: R$ ' + CONFIG.taxaEntrega.toFixed(2) + ')';
